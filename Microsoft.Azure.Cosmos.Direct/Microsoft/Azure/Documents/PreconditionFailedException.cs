...
internal class PreconditionFailedException : DocumentClientException
{
	...
	public PreconditionFailedException(string message, Exception innerException, HttpResponseHeaders headers, Uri requestUri = null, SubStatusCodes? substatusCode = null)
